...
- Status: Accepted (amended by [ADR 0020](./0020-close-crud-idiom-gaps.md) — `intent` 필드)
- Date: 2026-04-17
...
| `intent` | enum (`"destructive-confirm"`) | ❌ | 파괴적 action 의 2단계 confirm 페이지 표식 — ADR 0020 §5 도입 |
...
- **Amended by ADR 0020 §5** — envelope 에 옵셔널 `intent: "destructive-confirm"` 필드 추가 (preview→confirm 2단계 destructive idiom 표식).
